export function SuitabilityLegend() {
  return (
    <div className="suitability-legend">
      ...
      <p>
        Continuous fit wash (drive, quiet, traffic, safety, walk, ocean,
        sunset, air) clipped to your isochrones, with brighter peaks at strong
        listing addresses. Adjust weights in the criteria panel.
      </p>
      <div
